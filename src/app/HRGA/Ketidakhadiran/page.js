...
import Tabelhpch from "@/components/HRGA/Ketidakhadiran/tabelhpch";
      ...
      <section>
        <div className="flex flex-col w-full h-auto gap-y-8 p-4">
          <div className="flex justify-center space-x-4">
            ...
            <Link
              href="/HRGA/Ketidakhadiran/verifikasiPengajuan"
            ...
            <Link
              href="/HRGA/Ketidakhadiran/listData"
              className="btn bg-second flex items-center gap-2 p-4 rounded-full"
            >
              <UnorderedListOutlined />
              List Data Pegawai
            ...
            <Link
              href="/HRGA/Ketidakhadiran/calendar"
              className="btn bg-second flex items-center gap-2 p-4 rounded-full"
            >
              <CalendarOutlined />
              Calendar
            ...
            <div className="bg-white rounded-xl shadow-md overflow-x-auto w-full">
              <div className="p-6">
                ...
                <div className="w-full overflow-x-auto">
                  <Tabelhpch modal13={handleModalOpen} />
                </div>
              </div>
            </div>
          </div>
