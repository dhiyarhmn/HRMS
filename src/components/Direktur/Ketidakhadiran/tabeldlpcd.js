...
const Tabeldlpcd = ({ employeeId }) => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `http://127.0.0.1:8000/api/historyByID/${employeeId}`,
          {
            headers: {
        ...
        console.log("Data dari API absenceHistory:", absenceHistory); // Debug: Cek data yang diterima
        setDataKetidakhadiran(absenceHistory);
  ...
  return (
    ...
    scroll={{scrollToFirstRowOnChange: true,}}>
      ...
      <Column title="Jenis Ketidakhadiran" dataIndex="absence_code_description" align="center" {...getColumnSearchProps("absence_code_description")} />
      ...
      <ColumnGroup title="Persetujuan">
        ...
        {userRole === 2 && (
          <>
            ...
            <Column title="Direktur" dataIndex="approved_by_director" align="center" render={(persetujuan, record) => (
