...
const Tabelvpcd = React.forwardRef(({ detail, onRemoveData }, ref) => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          "http://127.0.0.1:8000/api/approvals/byrole",
          {
            headers: {
  ...
  return (
    ...
    >
      ...
      <Column
        ...
        dataIndex="absence_description"
        align="center"
        {...getColumnSearchProps("absence_description")}
      />
      <Column
        title="Action"
        align="center"
